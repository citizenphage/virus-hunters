...
1.  Aliquot sample into a 50 mL Falcon tube to about the 10 mL mark
2.  Top up with pH 7.5 SM buffer to ~ 45 mL.
3.  Leave on a rotor to mix for ~ 1hr (this softens the material)
4.  Vortex for 1-2 mins.
5.  Centrifuge at 4080 xg for 10 mins at 4 °C. This stage is just to get rid of the bulk material, so can be done in the benchtop centrifuge in GP211.
6.  Pass the supernatant through a Pluriselect 40 µm mesh filter into a fresh 50 mL Falcon tube to the 40 mL mark. Draw an arrow on the lid and mark the side where the pellet is going to be.
7.  Centrifuge at 10,000 xg for 30 mins at 4 °C. This requires the ThermoScientific Multifuge X3R on the 4th floor.
8.  In a flow hood, filter through a 0.2 µm PES filter into an acid-washed and autoclaved 20 mL amber glass vial (Fisher 11503552). You may have to re-centrifuge if it's really clogging the filter. Use a luer-lock syringe and filter for this to avoid it popping off and spraying everywhere!
9.  Label the glass vial with the [What3Words](https://what3words.com/) label. Also on the side, write the date it was processed and your name.
...
6.  Label the sterilin with the What3Words label on both the top and the side. Also on the side, write the date it was processed and your name.
